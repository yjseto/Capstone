# -*- coding: utf-8 -*-
"""crash_Random_Forest.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lJVATpLSbVQEK0cWepSpOUyaMawZvttS
"""
...
# Define the hyperparameter grid to search for Random Forest (including class_weight)
'''
param_grid = {
...
best_clf = RandomForestClassifier(random_state=42, n_estimators=1000, max_depth=10, min_samples_split=2, min_samples_leaf=4, class_weight=class_weights)
...
estimator = best_clf.estimators_[0]  # Get the first tree in the forest
